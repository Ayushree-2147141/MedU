import React, { useState, useRef, useEffect, useContext, PureComponent } from "react";
...
export default function Prescribe() {
    ...
    const jspdfgenerator = () =>{
        ...
        doc.text(20,20,"Hello this is new PDF file");
    ...
    const message = async (e) => {
        ...
        try {
            ...
            const result = await fetch('http://127.0.0.1:8000/data', {
                method: 'POST',
                headers: {
    ...
    const Annotationsection = () => {
        return (
			...
			<br/>
			{/* <button type="button" class="btn btn-success" id="previewbtn" onClick={jspdfgenerator}> Show Preview</button> */}
            <button type="button" class="btn btn-success" id="previewbtn" onClick={handleShow}> Show Preview</button>
            {/* <button type="button" class="btn" id="pdfGenerate" onClikc={functionCall}>Generate PDF</button> */}
                    </div>
